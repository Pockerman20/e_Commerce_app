...
class FirebaseFirestoreHelper {
  ...
  Future<bool> uploadFavouriteProductFirebase(
      List<ProductModel> list, BuildContext context, String payment) async {
    try {
      showLoaderDialog(context);
      double totalPrice = 0.0;
      ...
      DocumentReference admin =
          _firebaseFirestore.collection("favourites").doc();
      ...
      Navigator.of(context, rootNavigator: true).pop();
      showMessage("Favourite added Successfully");
      return true;
    } catch (e) {
      showMessage(e.toString());
      Navigator.of(context, rootNavigator: true).pop();
  ...
  Future<List<ProductModel>> getFavourite() async {
    try {
      ...
      List<ProductModel> orderList = querySnapshot.docs
